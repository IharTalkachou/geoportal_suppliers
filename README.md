...
- Аналитики: KPI, календарь дедлайнов, загрузка сотрудников, сводный прогресс проектов, реестры/экспорт в Excel, автоматический ежемесячный отчёт НИПД (генерация `.docx`)
